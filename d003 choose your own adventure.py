  ...
  *******************************************************************************
  ...
  if cross_road == "left":
      ...
      if dock == "wait":
          ...
          door = input("There are three doors. Which door do you take? \"red,\" \"yellow,\" or \"blue\"?\n")
          if door == "red":
              print("You slowly open the red door, only to feel an immense heat surround you as you are immolated.")
              restart = input("Try again?\n")
              if restart == "yes" or restart == "Yes" or restart == "Y" or restart == "Yes" or restart == "YES":
                script()
              else:
      ...
      print("Along the right path is a thick forest. In your clumsiness, you trip over a felled branch.")
      print("A hungry bear hears your struggle and attacks.")
      restart = input("Try again?\n")
      if restart == "yes" or restart == "Yes" or restart == "Y" or restart == "Yes" or restart == "YES":
        script()
      else:
